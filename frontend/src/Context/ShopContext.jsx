  ...
  const addToCart = async (itemId) => {
    ...
    if (addedItem) {
      ...
      try {
        ...
        await axios.post(
          "https://e-commerce-i73s8i1qp-vivekbutola3.vercel.app/api/cart",
          {
            userId: user._id,
  ...
  const removeFromCart = async (itemId) => {
    ...
    try {
      const response = await axios.delete(
        `https://e-commerce-i73s8i1qp-vivekbutola3.vercel.app/api/cart/${itemId}`
      );
    ...
    async function fetchCartData() {
      try {
        const response = await axios.get(
          `https://e-commerce-i73s8i1qp-vivekbutola3.vercel.app/api/cart/${user._id}`
        );
